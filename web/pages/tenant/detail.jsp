...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/tenant/dashboard.css?v=1.6" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/tenant/detail.css?v=1.6" />
            ...
            <div class="report-modal-body">
                <form id="reportForm" onsubmit="submitReportForm(event)">
                    ...
                    <div class="form-group-modal">
                        ...
                        <input type="hidden" name="issueType" id="issueType" value="Harga Tidak Sesuai" required>
                        <div class="custom-dropdown-modal" id="reportIssueDropdown">
                            <div class="dropdown-trigger-modal">
                                <span class="trigger-label-modal">Harga di web tidak sesuai saat bertemu</span>
                                <svg class="chevron-icon-modal" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </div>
                            <div class="dropdown-menu-modal">
                                <div class="dropdown-option-modal selected" data-value="Harga Tidak Sesuai">Harga di web tidak sesuai saat bertemu</div>
                                <div class="dropdown-option-modal" data-value="Gambar Tidak Sesuai">Gambar/Foto properti tidak sesuai aslinya</div>
                                <div class="dropdown-option-modal" data-value="Indikasi Penipuan/Scam">Sudah bayar tetapi tidak ada informasi lanjut (Scam)</div>
                                <div class="dropdown-option-modal" data-value="Lainnya">Lainnya</div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group-modal" style="margin-top: 16px;">
                        <label for="reportDescription">Deskripsi Kronologi</label>
                        <textarea id="reportDescription" name="description" rows="4" placeholder="Jelaskan secara rinci tentang pelanggaran atau penipuan yang terjadi..." required></textarea>
                    </div>
