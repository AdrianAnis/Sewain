        ...
        <div class="profile-card">
            ...
            <div class="profile-avatar-section">
                ...
                <div class="avatar-info">
                    <h1 class="profile-name" id="displayName"><%= currentUser.getName() %></h1>
                    <span class="profile-role-badge"><%= currentUser.getRole() %></span>
                </div>
            </div>
            ...
            <form id="profileForm" class="profile-form" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <svg class="input-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.37 2 2 0 0 1 3.61 1.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.96a16 16 0 0 0 6.13 6.13l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
                        </svg>
