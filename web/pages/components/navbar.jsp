        ...
        <div class="nav-auth">
            ...
            <% } else { %>
                <% if ("Tenant".equalsIgnoreCase(role)) { %>
                    <!-- Wishlist Heart Link (Tenant only) -->
                    <a href="<%= contextPath %>/pages/tenant/wishlist.jsp" class="nav-icon-btn" aria-label="Favorit">
                ...
                <div class="nav-profile-container">
                    <button class="nav-avatar-btn" id="avatarBtn" aria-label="Menu Profil">
                        ...
                        <span class="nav-username"><%= currentUser.getName() %></span>
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        <div class="dropdown-user-info">
                            <div class="name"><%= currentUser.getName() %></div>
                            <div class="email"><%= currentUser.getEmail() %></div>
                            <span class="badge"><%= currentUser.getRole() %></span>
                        </div>
                        <div class="dropdown-menu-list">
                            <!-- Edit Profil -->
                            <a href="<%= contextPath %>/profile" class="dropdown-item">
                                <i class="fa-solid fa-circle-user"></i>
                                Edit Profil
                            </a>

                            <% if ("Owner".equalsIgnoreCase(role)) { %>
                                <!-- Riwayat Laporan Owner -->
                            ...
                            <% } else if ("Tenant".equalsIgnoreCase(role)) { %>
                                ...
                                <!-- Daftar Jadi Owner / View as Owner -->
                                <% 
                                    String roleSession = (String) session.getAttribute("roleSession");
                                    if ("owner".equalsIgnoreCase(roleSession)) { 
                                %>
                                    <a href="<%= contextPath %>/switch-role" class="dropdown-item" style="color: var(--primary);">
                                        <i class="fa-solid fa-arrows-rotate"></i>
                                        View as Owner
                            ...
                            <% } else if ("Admin".equalsIgnoreCase(role)) { %>
                                <!-- Menu Admin -->
                                <a href="<%= contextPath %>/pages/admin/dashboard_admin.jsp" class="dropdown-item">
                                    <i class="fa-solid fa-gauge"></i>
                                    Dashboard Admin
                                </a>
                            <% } %>

                            <a href="<%= contextPath %>/logout" class="dropdown-item logout">
