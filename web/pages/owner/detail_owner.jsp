    ...
    <%@page import="model.User, model.Property, model.Kost, model.Rumah, model.Kontrakan, model.Apartement, DAO.PropertyDAO" %>
    <% 
        // Ensure user session exists and role is owner 
        ...
        int ownerId = 1;
        try { ownerId = Integer.parseInt(currentUser.getUserId()); } catch(Exception e) {}



        // Retrieve specific property details passed by Servlet
    ...
    <body>
        ...
        <div id="deleteModal" class="delete-modal">
            <div class="delete-modal-content">
                ...
                <p>Are you sure you want to delete this property? This action is permanent and cannot be undone.</p>
