...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/owner/add_property.css?v=1.0" />
...
<body>
    ...
    <div style="max-width: 800px; margin: 40px auto 0; padding: 0 24px;">
        <a href="${pageContext.request.contextPath}/pages/owner/dashboard_owner.jsp" class="btn-back" style="display: inline-flex; align-items: center; gap: 8px; text-decoration: none;">
    ...
    <!-- MAIN FORM -->
    <form id="propertyForm" action="${pageContext.request.contextPath}/owner/edit" method="POST" enctype="multipart/form-data" 
        ...
        <input type="hidden" name="existingPhotos" id="existingPhotosInput" value="<%= property.getPhotos() != null ? property.getPhotos() : "" %>">
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="<%= property.getName() %>" placeholder="e.g. Exclusive Kost for Men in Tebet" required>
            </div>
            
            <div class="form-group">
                <label class="form-label">Tipe Properti (Tidak dapat diubah)</label>
                <input type="hidden" name="type" id="propertyTypeInput" value="<%= property.getPropertyType() %>">
            ...
            <div class="form-group">
                ...
                <textarea name="location" class="form-control" placeholder="Masukkan alamat lengkap properti" required><%= property.getLocation() %></textarea>
            </div>
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="number" name="price" class="form-control" value="<%= (long)property.getPrice() %>" placeholder="0" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-select-container">
                        ...
                        <div class="custom-select-trigger has-value" onclick="toggleDropdown(this)">
                            <span><%= property.isAvailability() ? "Available" : "Unavailable" %></span>
        ...
        <div class="form-card">
            ...
            <div id="specificFields">
                <% 
                    String propType = property.getPropertyType() != null ? property.getPropertyType().trim().toLowerCase() : "";
                    if ("kost".equals(propType)) { 
                        String currentGender = property.getGender() != null && !property.getGender().isEmpty() ? property.getGender() : "Male";
                        String currentRoomType = property.getRoomType() != null ? property.getRoomType() : "";
                %>
                    <div class="grid-2">
                        <div class="form-group" style="margin-bottom: 0;">
                            <label class="form-label">Gender Type</label>
                            <div class="segmented-control">
                                <input type="hidden" name="gender" id="genderInput" value="<%= currentGender %>" required>
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <div class="custom-select-container">
                                <input type="hidden" name="roomType" value="<%= currentRoomType %>" required>
                                <div class="custom-select-trigger <%= !currentRoomType.isEmpty() ? "has-value" : "" %>" onclick="toggleDropdown(this)">
                                    <span><%= !currentRoomType.isEmpty() ? currentRoomType : "Select Room Type" %></span>
                                    <i class="fa-solid fa-chevron-down"></i>
                                </div>
                                <div class="custom-select-options">
                ...
                <% } else if ("rumah".equals(propType)) { %>
                    <div class="grid-2">
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="number" name="jumlahKamar" class="form-control" value="<%= property.getJumlahKamar() %>" placeholder="0" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                            <label class="form-label">Luas Tanah (m²)</label>
                            <input type="number" step="0.01" name="luasTanah" class="form-control" value="<%= property.getLuasTanah() %>" placeholder="0.0" required>
                        </div>
                    </div>
                <% } else if ("kontrakan".equals(propType)) { %>
                    <div class="grid-2">
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="number" name="durasiMinimum" class="form-control" value="<%= property.getDurasiMinimum() %>" placeholder="Misal: 12" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                            <label class="form-label">Jumlah Kamar</label>
                            <input type="number" name="jumlahKamar" class="form-control" value="<%= property.getJumlahKamar() %>" placeholder="0" required>
                ...
                <% } else if ("apartement".equals(propType) || "apartemen".equals(propType)) { 
                    String currentTipeUnit = property.getTipeUnit() != null ? property.getTipeUnit() : "";
                %>
                    <div class="grid-3">
                        <div class="form-group" style="margin-bottom: 0;">
                            <label class="form-label">Floor Number</label>
                            <input type="number" name="lantai" class="form-control" value="<%= property.getLantai() %>" placeholder="0" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                            <label class="form-label">Unit Number</label>
                            <input type="text" name="nomorUnit" class="form-control" value="<%= property.getNomorUnit() %>" placeholder="A-102" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 0;">
                            <label class="form-label">Unit Type</label>
                            <div class="custom-select-container">
                                <input type="hidden" name="tipeUnit" value="<%= currentTipeUnit %>" required>
                                <div class="custom-select-trigger <%= !currentTipeUnit.isEmpty() ? "has-value" : "" %>" onclick="toggleDropdown(this)">
                                    <span><%= !currentTipeUnit.isEmpty() ? currentTipeUnit : "Select Unit Type" %></span>
                                    <i class="fa-solid fa-chevron-down"></i>
                                </div>
                                <div class="custom-select-options">
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" placeholder="Describe the key features and atmosphere..." required><%= property.getDescription() %></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="custom-facilities-section" style="margin-top: 24px; border-top: 1px solid var(--border); padding-top: 24px;">
                    <label class="form-label">Fasilitas Tambahan (Custom)</label>
                    <div style="display: flex; gap: 12px; margin-bottom: 12px;">
                        <input type="text" id="customFacInput" class="form-control" placeholder="Ketik fasilitas lainnya (misal: Balkon)">
                        <button type="button" class="btn-next" style="padding: 12px 24px; flex-shrink: 0;" onclick="addCustomFacility()">+ Add</button>
                    </div>
        ...
        <div class="form-card">
            ...
            <!-- Cover Image -->
            <div class="form-group">
                <label class="form-label">Cover Image <span style="font-weight: normal; color: var(--text-secondary);">(Biarkan kosong jika tidak ingin mengganti foto)</span></label>
                <div class="dropzone" id="coverDropzone" onclick="document.getElementById('coverPhotoInput').click()">
                    ...
                    <img id="coverPreview" src="" alt="Cover Preview" style="display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
                    <button type="button" id="removeCoverBtn" style="display: none; position: absolute; top: 16px; right: 16px; background: rgba(255, 255, 255, 0.9); border: none; border-radius: 50%; width: 36px; height: 36px; cursor: pointer; color: var(--deep); box-shadow: var(--shadow-sm); z-index: 10; align-items: center; justify-content: center;" onclick="removeCoverPhoto(event)">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                    <input type="file" name="cover_photo" id="coverPhotoInput" style="display:none;" accept="image/*">
                </div>
            </div>

            <!-- Gallery Photos -->
            <div class="form-group" style="margin-bottom: 0;">
                <label class="form-label">Gallery Photos <span style="font-weight: normal; color: var(--text-secondary);">(Add up to 5 photos)</span></label>
                <div class="gallery-grid" id="galleryGrid">
                    ...
                    <div class="gallery-placeholder"><i class="fa-solid fa-image" style="font-size: 24px;"></i></div>
                    <div class="gallery-placeholder"><i class="fa-solid fa-image" style="font-size: 24px;"></i></div>
                    <div class="gallery-placeholder"><i class="fa-solid fa-image" style="font-size: 24px;"></i></div>
                </div>
                <input type="file" name="gallery_photos" id="galleryInput" multiple style="display:none;" accept="image/*">
            </div>
        </div>

        <!-- Submit & Cancel Actions -->
        <div class="form-actions">
            <a href="${pageContext.request.contextPath}/pages/owner/dashboard_owner.jsp" class="btn-back" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center;">Batal</a>
