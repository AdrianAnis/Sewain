(function() {
  ...
  // === BUG 2 FIX: Sanitize favorites in localStorage ===
  try {
  ...
  // === BUG 1 FIX: Intercept fetch to prepend context path to /uploads/ photos ===
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Update navbar favorites link behavior if needed
  ...
  // 3. Fetch real property details from Database
  ...
  // 5. Card Interactions (Delete with Fade-Out & Parallax Tilt)
