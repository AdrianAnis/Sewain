                                                        ...
                                                        document.addEventListener("click", function (e) {
                                                            if (!profileDropdown.contains(e.target) && !e.target.closest("#avatarBtn")) {
                                                                profileDropdown.style.display = "none";
                                                                                                   ...
                                                                                                   // Dynamic properties loaded from window
  ...
  <line x1="7" y1="7" x2="7.01" y2="7"/>
                                                ...
                                                // Render tags (Category + Verified Badge)
                ...
                <div class="verified-badge">
                    ...
                    Verified
                                                ...
                                                property.facilities.forEach(function (facility) {
                                                    // Case-insensitive facility icon lookup
                                                    let foundIcon = null;
                                                 ...
                                                 // Image helper functions resolved via property-utils.js
                                    ...
                                    if (pType === "kost") {
                                        ...
                                        <span style="display: flex; align-items: center; gap: 6px;">
                                            ...
                                            ${p.tipeUnit || "Studio"}
                                                ...
                                                // 5-Photo Grid with beautiful mock interiors matching the design
            ...
            `;
                ...
                `;
                                                ...
                                                // Add click navigation to recommendation cards
                                                document.querySelectorAll(".recommendations-grid .property-card").forEach(function (card) {
                                                    // Clicking the card navigates unless clicking the wishlist button
                                                ...
                                                // Bind wishlist heart buttons in recommendations grid
                                                ...
                                                wishlistBtns.forEach(btn => {
                                                    btn.addEventListener("click", function (e) {
                                                        ...
                                                        // If it is the current property, sync the sidebar wishlist button
                                                        if (id === property.id) {
                                                ...
                                                // Sync/update function for sidebar wishlist button
                    ...
                    `;
                                                ...
                                                // Wishlist toggle logic for sidebar
                                                const sidebarBtn = document.getElementById("sidebarWishlistBtn");
                                                if (sidebarBtn) {
                                                    sidebarBtn.addEventListener("click", function (e) {
                                                        ...
                                                        // Sync the wishlist heart button on recommendations cards if it exists there
                                                ...
                                                // 3D Parallax Tilt hover effect for recommendation cards
                                                ...
                                                // Populate Lightbox markup elements dynamically
                                                ...
                                                // Lightbox slider state and navigation functions
                                                ...
                                                window.goToSlide = function (index) {
                                                    ...
                                                    // Toggle active border styling on thumbnail previews
                                                ...
                                                // Touch Swipe & Mouse Drag carousel gesture handlers
                                                ...
                                                function dragMove(e) {
                                                    ...
                                                    // Instant slide tracking translation
                                                ...
                                                function dragEnd(e) {
                                                    ...
                                                    // 15% threshold for switching images
                                                ...
                                                // Set default date check-in picker to tomorrow
                                                ...
                                                // Custom dropdown modal interactivity
                                                const dropdownModal = document.getElementById("reportIssueDropdown");
                                                if (dropdownModal) {
