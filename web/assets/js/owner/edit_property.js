let selectedGalleryFiles = []; // Store {isExisting, file, url, originalUrl} objects
...
document.getElementById('propertyForm').addEventListener('submit', function(e) {
    ...
    // Sync existing photos list to handle deletions
    ...
    // Sync newly uploaded files into galleryInput element
...
// Clear invalid styling on change
