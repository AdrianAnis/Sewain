// web/assets/js/add_property.js
// JavaScript khusus untuk halaman Add Property (Wizard/Stepper)

let currentStep = 1;
let selectedGalleryFiles = []; // Store {file, url} objects
...
// PROPERTY TYPE SELECTION (Dynamic Fields Injection)
...
// Add on enter key for custom facility input
