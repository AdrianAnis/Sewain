...
public class AdminFlagServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("unflagProperty".equalsIgnoreCase(action)) {
            ...
            if (success) {
                String desc = "Admin " + currentUser.getName() + " mencabut flag pada properti: " + prop.getName() + " (ID: " + propertyId + ")";
            ...
            if (success) {
                String desc = "Admin " + currentUser.getName() + " menghapus properti secara permanen: " + prop.getName() + " (ID: " + propertyId + ")";
