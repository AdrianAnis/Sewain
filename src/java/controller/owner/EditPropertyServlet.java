...
public class EditPropertyServlet extends HttpServlet {
    ...
    private void sendResponse(HttpServletRequest request, HttpServletResponse response, boolean success, String message, Integer propertyId) throws IOException {
        String acceptHeader = request.getHeader("Accept");
        boolean isJsonRequest = (acceptHeader != null && acceptHeader.contains("application/json")) || "XMLHttpRequest".equals(request.getHeader("X-Requested-With"));
        ...
        if (isJsonRequest) {
            ...
            if (success) {
                response.sendRedirect(request.getContextPath() + "/owner/detail?propertyId=" + propertyId + "&updated=true");
            } else {
