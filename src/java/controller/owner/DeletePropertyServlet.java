...
public class DeletePropertyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (property == null || property.getOwnerId() != ownerId) {
            // Tolak dengan error
            response.sendError(HttpServletResponse.SC_FORBIDDEN, "Anda tidak memiliki akses untuk menghapus properti ini.");
            return;
        }

        // PBO Compliance: Panggil deleteProperty() pada objek Owner
