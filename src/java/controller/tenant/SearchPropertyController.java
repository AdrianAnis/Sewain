...
public class SearchPropertyController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Fetch properties from DB as Property objects
        List<Property> properties = propertyDAO.searchProperties(name, location, price, type);
        
        // Convert to JSON string using Property encapsulation methods
        String json = convertToJson(properties);
        
        // Pass JSON string to JSP
    ...
    private String convertToJson(List<Property> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            // Format price label dynamically
