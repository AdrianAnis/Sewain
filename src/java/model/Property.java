...
public abstract class Property implements Reportable {
    ...
    public String getOwnerProfilePic() { return ownerProfilePic; }
    public void setOwnerProfilePic(String ownerProfilePic) { this.ownerProfilePic = ownerProfilePic; }
    ...
    // Polymorphic Subclass Field Getters to avoid instanceof checks
    public String getGender() { return ""; }
    public String getRoomType() { return ""; }
    public int getJumlahKamar() { return 0; }
    public double getLuasTanah() { return 0.0; }
    public int getDurasiMinimum() { return 0; }
    public int getLantai() { return 0; }
    public String getNomorUnit() { return ""; }
    public String getTipeUnit() { return ""; }
